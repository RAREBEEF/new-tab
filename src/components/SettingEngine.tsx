...
import styles from "./SettingEngine.module.scss";
import { useCallback } from "react";
import { useDispatch, useSelector } from "react-redux";
import { setSerachEngineAction } from "../redux/reducers/modules/userSetting";
import { SettingEngineProps, userSettingType } from "../types";
import Button from "./Button";

const SettingEngine: React.FC<SettingEngineProps> = ({ setPage }) => {
        ...
        >
          <img
            ...
            className={classNames(
              ...
              userSetting.engine === "google" && styles.selected
            )}
            alt="구글"
          ...
          <img
            ...
            className={classNames(
              styles["search-engine-logo"],
              userSetting.engine === "naver" && styles.selected
            )}
            alt="네이버"
          ...
          <img
            ...
            className={classNames(
              styles["search-engine-logo"],
              userSetting.engine === "daum" && styles.selected
            )}
            alt="다음"
